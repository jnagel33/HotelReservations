...
+ (void)drawSectionHeaderWithFrame: (CGRect)frame
{
    ...
    //// Rectangle Drawing
    CGRect rectangleRect = CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), 1024, 40);
...
+ (void)drawTableViewHeaderWithFrame: (CGRect)frame
{
    //// General Declarations
    CGContextRef context = UIGraphicsGetCurrentContext();

    //// Color Declarations
    UIColor* gradientColor = [UIColor colorWithRed: 0.729 green: 0.725 blue: 0.725 alpha: 1];
    UIColor* gradient4Color = [UIColor colorWithRed: 0 green: 0 blue: 0 alpha: 1];
    UIColor* gradient4Color2 = [UIColor colorWithRed: 0.311 green: 0.311 blue: 0.311 alpha: 1];

    //// Gradient Declarations
    CGFloat gradient4Locations[] = {0, 0, 0.5, 1, 1};
    PCGradient* gradient4 = [PCGradient gradientWithColors: @[gradient4Color, [gradient4Color blendedColorWithFraction: 0.5 ofColor: gradient4Color2], gradient4Color2, [gradient4Color2 blendedColorWithFraction: 0.5 ofColor: UIColor.blackColor], UIColor.blackColor] locations: gradient4Locations];

    //// Shadow Declarations
    NSShadow* shadow2 = [[NSShadow alloc] init];
    [shadow2 setShadowColor: gradientColor];
    [shadow2 setShadowOffset: CGSizeMake(0.1, -0.1)];
    [shadow2 setShadowBlurRadius: 5];

    //// Rectangle Drawing
    CGRect rectangleRect = CGRectMake(CGRectGetMinX(frame) + floor(CGRectGetWidth(frame) * 0.00000 + 0.5), CGRectGetMinY(frame) + floor(CGRectGetHeight(frame) * 0.00826 + 0.5), floor(CGRectGetWidth(frame) * 1.00000 + 0.5) - floor(CGRectGetWidth(frame) * 0.00000 + 0.5), floor(CGRectGetHeight(frame) * 1.00000 + 0.5) - floor(CGRectGetHeight(frame) * 0.00826 + 0.5));
    UIBezierPath* rectanglePath = [UIBezierPath bezierPathWithRect: rectangleRect];
    CGContextSaveGState(context);
    [rectanglePath addClip];
    CGContextDrawLinearGradient(context, gradient4.CGGradient,
        CGPointMake(CGRectGetMidX(rectangleRect), CGRectGetMinY(rectangleRect)),
        CGPointMake(CGRectGetMidX(rectangleRect), CGRectGetMaxY(rectangleRect)),
        0);
    CGContextRestoreGState(context);
